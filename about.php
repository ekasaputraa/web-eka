...
<!-- Header -->
<header class="bg-blue-900 text-white text-center p-6 text-2xl font-bold"> About Me | rizki faturrohman
</header>
<!-- Navigation -->
...
while ($data = mysqli_fetch_array($query)) { echo "<div>";
...
<!-- Footer -->
<footer class="bg-blue-800 text-white text-center py-4 mt-10"> &copy; <?php echo date('Y'); ?> | Created by rizki faturrohman
</footer>
